...
class _HomePageState extends State<HomePage> {
  String desc =
      "Software Developer, #Flutter enthusiast | #Android developer @Vita technologies";
              ...
              children: <Widget>[
                GestureDetector(
                  onTap: (){
                    ...
                    child: Image.asset("assets/images/github.png", width: 23,height: 23,)
                ),
                SizedBox(
                  width: 16,
                ),
                GestureDetector(
                  onTap: (){
                    _launchURL("https://www.linkedin.com/in/rahman-mohammad-106530112/");
                  },
                    child: Image.asset("assets/images/linkedin.png", width: 23,height: 23,)
                ),
                SizedBox(
                  width: 16,
                ),
